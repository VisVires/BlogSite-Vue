...
nohup ./mvnw spring-boot:run -Dspring-boot.run.arguments="--spring.data.mongodb.password=${mongoPass} --wgeorge.app.root.user=${userName} --wgeorge.app.root.password=${password} --wgeorge.app.set.root.toggle=true" &
